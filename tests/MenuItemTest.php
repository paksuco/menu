...
class MenuItemTest extends TestCase
{
    ...
    public function test_should_instantiate_statically()
    {
        ...
        $this->assertTrue($menuItem->getChildren() instanceof MenuContainer);
    }
    ...
    public function test_should_have_a_string_representation()
    {
        ...
        $this->assertSame($menuItem->build(), $menuItem . "");
    }
    ...
    public function test_should_add_menu_item_to_children()
    {
        ...
        $this->assertEquals(1, $menuItem->getChildren()->count());
    ...
    public function test_should_throw_exception_when_adding_different_types()
    {
        $this->expectException(InvalidTypeException::class);
        $menuItem = MenuItem::create("new Menu Item", "fa fa-icon", "https://example.com", null);
        $menuItem->getChildren()->push("testing");
    }
